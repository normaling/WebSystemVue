    ...
    <template>
      <el-table :data="tableData" style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" label="职位">
          <template slot-scope="scope">
            <span style="margin-right: 10px" v-if="scope.row.job == 1">班长</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 2">副班长</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 3">团支书</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 4">学习委员</span>
          </template>
        </el-table-column>
