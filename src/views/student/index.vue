<template>
  <div class="app-container">
    ...
    <el-row>
      ...
      <el-button type="primary" size="medium" @click="dialogVisible = true; emp = { image: ''};">+ 新增学生</el-button>
    </el-row>
    ...
    <template>
      <el-table :data="tableData" style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" label="职位">
          <template slot-scope="scope">
            <span v-if="scope.row.job == 1" style="margin-right: 10px">班长</span>
            <span v-if="scope.row.job == 2" style="margin-right: 10px">副班长</span>
            <span v-if="scope.row.job == 3" style="margin-right: 10px">团支书</span>
            <span v-if="scope.row.job == 4" style="margin-right: 10px">学习委员</span>
          </template>
        </el-table-column>
